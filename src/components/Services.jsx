...
const services = [
  {
    ...
    img: "https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExeXFxd3RvMjl4Y210bWd2a2c5aWNic2N3MXZ5MjZrNHFseXFjbGNycCZlcD12MV9faW50ZXJuYWxfZ2lmX2J5X2lkJmN0PWc/QVUL20w0FwLKnQuX4D/giphy.gif",
  },
  {
    title: "Backend Development",
    desc: "Building secure, scalable, and high-performance backend systems using Node.js and Express.",
    img: "https://minnim.tv/proyectos/thecreativenet/backend.gif",
  },
  {
    title: "Database Management",
    desc: "Designing and managing efficient databases with MongoDB and SQL for seamless data handling.",
    img: "https://www.bing.com/th/id/OGC.07350f318c29fdb331f33d415675a46f?r=0&o=7&pid=1.7&rm=3&rurl=https%3a%2f%2fbmtraders.com%2fimages%2fDatabase%2fDatabase-5.gif&ehk=LxuX%2bjJ6P7GOltRxByaUD4fXK9Lr%2blPdviQ4O4zWlXE%3d",
  },
  {
    title: "API Development",
    desc: "Developing RESTful APIs to connect frontends with backends and ensure smooth communication.",
    img: "https://miro.medium.com/max/1400/1*2I5LcLiKtKJatDJVRpaYyA.gif",
  },
  {
    title: "Website Maintenance",
    desc: "Providing regular updates, bug fixes, and performance optimizations to keep your site running smoothly.",
    img: "https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExamR1MnBxamprYTN5aWE5N2VxOW9qazZiYXJkbTNvNngwZXJxZ2VjbSZlcD12MV9faW50ZXJuYWxfZ2lmX2J5X2lkJmN0PWc/qgQUggAC3Pfv687qPC/giphy.gif",
  },
  {
    title: "UI/UX Design",
    desc: "Designing intuitive, visually appealing, and user-centered layouts for web applications.",
    img: "https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/be510767817393.5b472244e895f.gif",
  },
];
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          {services.map((service, idx) => (
            <div
              ...
              onClick={() => handleToggle(idx)} // 👈 Toggle on tap
            >
              {/* Background image */}
              <img
                src={service.img}
              ...
              {/* Overlay */}
              <div
                className={`absolute inset-0 bg-black bg-opacity-50 transition duration-500 flex flex-col justify-center items-center text-center p-4
